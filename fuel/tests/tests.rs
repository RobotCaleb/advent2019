...
mod tests {
    ...
    fn line_1() {
        ...
        assert_eq!(fl.segments[0].start, vector::Vector2::new(0.0, 0.0));
    ...
    fn line_3() {
        ...
        let hit = fm.get_intersection(0, 1);
        assert_eq!(
            vector::Vector2::new(0.0, 0.0).dist_man(&hit.unwrap()),
            159.0
        );
    }
    #[test]
